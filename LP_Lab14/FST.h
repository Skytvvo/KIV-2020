...
//траблы со скобкой ')'
#define FST_DOUBLE_LITERAL FST::FST(2,\
FST::NODE(20,\
FST::RELATION('0', 0), FST::RELATION('.', 1),\
FST::RELATION('1', 0), FST::RELATION('.', 1),\
FST::RELATION('2', 0), FST::RELATION('.', 1),\
FST::RELATION('3', 0), FST::RELATION('.', 1),\
FST::RELATION('4', 0), FST::RELATION('.', 1),\
FST::RELATION('5', 0), FST::RELATION('.', 1),\
FST::RELATION('6', 0), FST::RELATION('.', 1),\
FST::RELATION('7', 0), FST::RELATION('.', 1),\
FST::RELATION('8', 0), FST::RELATION('.', 1),\
FST::RELATION('9', 0), FST::RELATION('.', 1)\
),\
FST::NODE())
