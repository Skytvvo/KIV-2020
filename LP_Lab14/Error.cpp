...
Error::ERROR errors[ERROR_MAX_ENTRY] = {
	...
	ERROR_ENTRY(700, "Ошибка семантического анализа: в функции отсутсвует return"),
	ERROR_ENTRY(701, "Ошибка семантического анализа: функция не всегда возвращает значение"),
	ERROR_ENTRY(702, "Ошибка семантического анализа: попытка объявить функцию в main"), ERROR_ENTRY(703,"Ошибка семантического анализа: ошибка в блоке main: функция возвращает не целочисленное занчение"),
	ERROR_ENTRY(704,"Ошибка семантического анализа: тип возвращаемого значения не соответствует типу функции"), ERROR_ENTRY(705,"Ошибка семантического анализа: слишком много аргументов передано в функцию"),
	ERROR_ENTRY(706,"Ошибка семантического анализа: тип передаваемого аргумента не соответствует типу параметра функции"), ERROR_ENTRY(707,"Ошибка семантического анализа: слишком мало аргументов передано в функцию"), 
	ERROR_ENTRY_NODEF(708,"Ошибка семантического анализа: попытка переопределить библиотечную функцию"), ERROR_ENTRY(709, "Ошибка семантического анализа: неопознаная библиотечная функция"), 
